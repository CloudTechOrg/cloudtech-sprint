...
### 要件1：サーバ構成
- EC2インスタンスが2台作成されていること（Webサーバ、APIサーバ）
- AMIはAmazon Linux 2023が使用されていること
- Webサーバのuserdataが正しく設定されていること
- APIサーバのuserdataが正しく設定されていること
- WebサーバのuserdataにAPIサーバのPrivate IPアドレスが設定されていること
...
- Webサーバ（EC2インスタンス）を再起動してもパブリックIPアドレスが変化しないこと
