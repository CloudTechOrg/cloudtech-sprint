...
- コンテナを実行するための基盤が構築されていること

### 要件2：環境変数の設定
- コンテナに`DB_HOST`が設定されていること
- コンテナに`DB_USER`が設定されていること
- コンテナに`DB_PASSWORD`が設定されていること
- コンテナに`DB_NAME`が `meibo` で設定されていること
