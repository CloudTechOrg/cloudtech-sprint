...
### 問題1：マルチアカウント戦略のメリット
単一のAWSアカウントですべてのリソースを管理する方法と比較して、AWS Organizationsを使用したマルチアカウント戦略を採用するメリットについて、「セキュリティ」「コスト管理」「ガバナンス」の観点から説明してください。

### 問題2：SCPの役割と特徴
サービスコントロールポリシー（SCP）とは何か、その役割を説明してください。また、IAMポリシーとの違いと、SCPを使用することでどのようなガバナンスを実現できるか、具体例を交えて説明してください。

### 問題3：AssumeRoleの仕組み
AWS STSのAssumeRoleとは何か、その仕組みを説明してください。また、クロスアカウントアクセスを実現する際に、AssumeRoleを使用するメリットについても説明してください。

### 問題4：CloudTrailによる監査
AWS CloudTrailとは何か、その役割を説明してください。また、マルチアカウント環境において、CloudTrailのログを管理アカウントに集約することのメリットについても説明してください。
